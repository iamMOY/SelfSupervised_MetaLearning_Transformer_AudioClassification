...
def to_spectrogram(og_file_path, new_dir, length, **spec_args):
    ...
    audio_data = torch.from_numpy(audio_data).reshape((1,audio_data.shape[0]))
    fbank = torchaudio.compliance.kaldi.fbank(audio_data, htk_compat=True, sample_frequency=spec_args['sr'], use_energy=False,
                                                  window_type='hanning', num_mel_bins=spec_args['n_mels'], dither=0.0, frame_shift=10)
    fbank = fbank.numpy()
    print(fbank.shape)
...
# old_dir = 'C:\\Users\\arsht_h67\\Desktop\\Self_Supervised_Meta_Learning\\MetaAudio-A-Few-Shot-Audio-Classification-Benchmark\\ESC-50-master\\Sorted_npy'
# new_dir = 'C:\\Users\\arsht_h67\\Desktop\\Self_Supervised_Meta_Learning\\MetaAudio-A-Few-Shot-Audio-Classification-Benchmark\\ESC-50-master\\ESC_spec'
# sample_length = 5
