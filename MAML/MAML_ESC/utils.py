...
def path_start_up(params):
    ...
    result_dir = os.path.join(cwd,'results', params['base']['task_type'], add_on)

    # Task dircetory creation first
    task_dir = os.path.join(cwd,'results', params['base']['task_type'])
    ...
    log_path = os.path.join(cwd,'logs', log_file)
