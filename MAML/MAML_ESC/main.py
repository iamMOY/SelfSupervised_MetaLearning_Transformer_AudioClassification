...
from models.Conv_and_Hybrid import StandardCNN, StandardHybrid, FullyConnectedNetwork
...
if __name__ == '__main__':
    ...
    for name in params['models']:
        ...
        for i in model_loop:
            print(f'Running experiment: {i} of {NUM_REPEATS}')
